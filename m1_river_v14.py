...
training_log_file = "/home/tomasz/projekty/python/app_market_bot/app_market_bot/model_manager/neural_network_models/training_logs/river_training_v14_log.txt"
training_logger = LightLogger(training_log_file, logger_name="training_logger")


training_log_file = "/home/tomasz/projekty/python/app_market_bot/app_market_bot/model_manager/neural_network_models/training_logs/river_training_v14_api_log.txt"
training_api_logger = LightLogger(training_log_file, logger_name="training_api_logger")


training_log_file = "/home/tomasz/projekty/python/app_market_bot/app_market_bot/model_manager/neural_network_models/training_logs/river_training_v14_order_log.txt"
training_order_logger = LightLogger(training_log_file, logger_name="training_order_logger")


training_log_file = "/home/tomasz/projekty/python/app_market_bot/app_market_bot/model_manager/neural_network_models/training_logs/river_training_v14_account_log.txt"
training_account_logger = LightLogger(training_log_file, logger_name="training_account_logger")


training_log_file = "/home/tomasz/projekty/python/app_market_bot/app_market_bot/model_manager/neural_network_models/training_logs/river_training_v14_websocket_log.txt"
...
class OrderExecutor:
    ...
    # async def monitor_profit(self) -> bool:
    #     """Monitoruje ogólny profit konta i zamyka pozycję przy dużej stracie"""
    #     try:
    #         result = await self.account.get_account()
    #         profit = result['profit']
            
    #         self.logger.debug(f"[MonitorProfit] Account profit: {profit:.2f} EUR")

    #         if profit <= -2.00:
    #             self.logger.warning(f"Force close: account profit = {profit:.2f} EUR")
    ...
    #     except Exception as e:
    #         self.logger.error(f"Error in monitor_profit: {str(e)}")
    #         return False
...
class RiverModelTrainer:
    ...
    def __init__(self, model_save_path: str = "/home/tomasz/projekty/python/app_market_bot/app_market_bot/model_manager/neural_network_models/snapshots/river_model_v7.pkl.gz"):
    ...
    def _log_signal(self, signal: Dict[str, Any]) -> None:
        ...
        self.logger.info(f"River-V14-DECISION: {json.dumps(log_entry)}")
    ...
    def save_model(self) -> None:
        ...
        try:
            ...
            backup_path = self.model_save_path.parent / f"river_model_v7_{timestamp}.pkl.gz"
    ...
    while True:
        try:
            async with websockets.connect(uri, ping_interval=20, ping_timeout=10) as websocket:
                logger.info("🚀 River V14 connected to websocket")
