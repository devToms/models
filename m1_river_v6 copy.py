...
class RiverModelTrainer:
    def __init__(self, model_save_path="/home/tomasz/projekty/python/app_market_bot/app_market_bot/model_manager/neural_network_models/river_models/river_model_v6.pkl.gz"):
